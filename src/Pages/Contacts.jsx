...
const Contacts = () => {
  ...
  return (
    <div id="#contacts">
      <Text color="blue" as="b" fontSize={["20px","23px","25px","25px"]} fontFamily="sans-serif" >CONTACT</Text>
      <div className={Styles.contacts}>
        ...
        <div className={Styles.contact}>
          ...
          <Text as="b" fontSize={["18px","18px","20px","22px"]} fontFamily="sans-serif">github</Text>
          <Box><a style={{textDecoration:"none",cursor:"pointer"}}  onClick={()=>openInNewTab("https://github.com/Hars28")}>
          <Text as="b" fontSize={["18px","18px","20px","22px"]} fontFamily="sans-serif">Hars28</Text>
          </a>
          </Box>
          </div>
        <div className={Styles.contact}>
          ...
          <Text as="b" fontSize={["18px","18px","20px","22px"]} fontFamily="sans-serif">linkedin</Text>
          <Box><a style={{textDecoration:"none",cursor:"pointer"}}  onClick={()=>openInNewTab("https://www.linkedin.com/in/harsh-singh-1a9b9322b/")}>
          <Text as="b" fontSize={["18px","18px","20px","22px"]} fontFamily="sans-serif">Harsh Singh</Text>
          </a>
          </Box>
          </div>
      </div>
